...
<p style="clear:both; padding:0 0 9px 0; margin:0; font-size:16px; display:none;">
<?php echo '<span class="titlewords" style="font-size:12px;">'._tr('客人要求时间').'</span>: '.$userchosen_d_time.$userchosen_d_time_adding.'.'; ?>
</p>

<button class="replytimebtn fullwidthbtn asrequesttimebtn" onclick="sendReply(<?php echo $orderid; ?>, 0)">OK</button>
...
function printTheTicket_in_format(){
	var a = "<?php echo 'Order date:\n'.htmlentities($neworder_order_created_at).'\n\n\n'; ?>";
	var b="<?php echo '*************************\n\n'; ?>";
	
	var c="<?php echo $neworder_content_dishes_only.'\n-------------------------\ntotal: '.htmlentities($neworder_order_totalprice).' euro\n\nNotification(Melding):\n'.htmlentities($neworder_order_usernote).'\n'.'\n-------------------------\n-------------------------\n-------------------------\n';?>";
...
?>
	...
	var b_chinese ="";
	var c_chinese ="<?php echo htmlentities($neworder_content_chinese).'\n--------------------\n总价格: '.htmlentities($neworder_order_totalprice).' \n\n\n';?>";;
...
function sendReply(orderid, delayminutes){
	...
	$.post( 
	  "sendconfirmation.php?inhouse=yes",
